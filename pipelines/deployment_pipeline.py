...
def continuous_deployment_pipeline(
    ...
    df = ingest_df("D:\MLOPs\TRY1\Data\olist_customers_dataset.csv")
    ...
    deployment_decision = deployment_trigger(accuracy=mse,config=DeploymentTriggerConfig(min_accuracy=0))
